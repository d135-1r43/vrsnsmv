/**
 * The VRS:NSMV cross, as raw path data on a 1000x1000 canvas.
 *
 * Kept apart from `Sigil.svelte` so it can also be dropped into a larger
 * drawing — the generated backdrop repeats it around a mandala.
 */
export const SIGIL_PATH =
	'M823.26,739.28l-75.05,78.77l-65.39-65.39l-68.37,65.39c-1-2.5-26.43-28.91-76.26-79.26l65.61-60.69' +
...
/** Side of the square the path is drawn on. */
export const SIGIL_VIEWBOX = 1000;
